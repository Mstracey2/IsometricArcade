...
public class InventoryManager : PanelUI
{
    ...
    public void SpawnObject(ButtonManager obj)
    {
        ...
        clone.GetComponent<ArcadeMachieneController>().SetNameAndIncome(name,income);                                       // sets the variables of the income and name of the machine so the machine know how much it should produce in currency
    }
